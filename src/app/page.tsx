    ...
    <>
      ...
      <main>
        ...
        <Section bgColor="#63353c" ref={aboutRef}>
          ...
          <SectionWrapper>
            <p>
              The Pizza Restaurant was founded in blabla by Mr. Italiano in
            ...
            <div className="flex justify-between items-center">
              <div className="flex flex-col justify-between self-stretch">
                <p>
                  <span className="font-bold">The Chef?</span> Mr. Italiano
                  himself
                </p>
            ...
            <article className="flex flex-col gap-y-6">
              <h3 className="font-bold text-4xl">Opening Hours</h3>
        ...
        <Section bgColor="#6b797b" ref={contactRef}>
          ...
          <SectionWrapper>
            ...
            <p>
              <span className="p-1 bg-black text-white">FYI!</span> We offer
              full-service catering for any event, large or small. We understand
              your needs and we will cater the food to satisfy the biggerst
              criteria of them all, both look and taste.
            </p>
            <p className="text-4xl">
              <strong>Reserve</strong> a table, ask for today&apos;s special or
